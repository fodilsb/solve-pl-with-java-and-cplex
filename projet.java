...
public class projet {
	...
	public static void solveMe() {
		...
		//entré le nombre de personne et machine
		Scanner sc=new Scanner(System.in);
		System.out.println("entrez le nombre de personne et de machine");
		int n=sc.nextInt();
		//remplissage de la matrice de productivité
		double [][]p=new double[n][n];
		for(int i=0;i<n;i++){
			for(int j=0;j<n;j++) {
				System.out.println("donnez la productivité de la personne " +j+" au poste " +i+ "\n");
		...
		try {
        	...
        	//deuxiéme contrainte (chaque personne est affecté a une seule machine)
        	for (int i=0; i<n; i++) {
        	...
        	//affichage des valeurs des variables de décisions
